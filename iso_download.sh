...
# the iso picker
echo "OS options:"
echo "Tails Lunix 7.10: 1" # https://mirrors.edge.kernel.org/tails/stable/tails-amd64-7.11/tails-amd64-7.11.iso
...
case $name in
    1)
        URL="https://mirrors.edge.kernel.org/tails/stable/tails-amd64-7.11/tails-amd64-7.11.iso"
        OSNAME="tails-amd64-7.11.iso"
        ;;
    2)
